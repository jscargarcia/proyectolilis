...
SECRET_KEY = config('DJANGO_SECRET_KEY', default='django-insecure-faan)^4ha-=$8+tf)jsxg=q6kk@%)h2j63!0#_^du1ku-14)ho')
...
MIDDLEWARE = [
    ...
    'autenticacion.middleware.ForcePasswordChangeMiddleware',  # Forzar cambio de password
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'autenticacion.context_processors.permisos_processor',
                'autenticacion.context_processors.usuario_info_processor',
            ],
        },
    },
]
...
# Email settings comunes
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@dulcerialilis.com')
SERVER_EMAIL = DEFAULT_FROM_EMAIL

# Configuración de negocio
COMPANY_NAME = config('COMPANY_NAME', default='Dulcería Lilis')

# Configuración de archivos subidos
FILE_UPLOAD_MAX_MEMORY_SIZE = 2621440  # 2.5MB

# Configuración para APIs - Permitir todos los orígenes para desarrollo
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rest_framework.authentication.BasicAuthentication',  # Solo Basic Auth para APIs
    ],
    ...
    # Configuración para APIs sin CSRF
